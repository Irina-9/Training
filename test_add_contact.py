...
class test_add_contact(unittest.TestCase):
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, phone_home, email):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firstname="werert", middlename="eretr", lastname="rtetre",
